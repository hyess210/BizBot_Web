...
var Store = /** @class */ (function () {
    function Store(initialState, options, persistenceDriver) {
        ...
        this.name = (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.name, (_b !== null && _b !== void 0 ? _b : this.generateStoreId(initialState)));
        if (options) {
...
function useIsolatedStore(initialState, storeOptions, persistenceDriver) {
    ...
    React__default.useEffect(function () {
        ...
        return function () {
            var _a;
            event.remove();
            if (!((_a = storeOptions) === null || _a === void 0 ? void 0 : _a.persistence)) {
